...
def rollback_cloud_run_revision(project_id: str, region: str, service_name: str, target_revision: str, dry_run: bool = False) -> Dict[str, Any]:
    ...
    try:
        ...
        # Allow mock rollback even if target equals current (common in CI with stubbed single-revision data)
        # Real production check for no-op is handled by traffic verification, not by blocking rollout here
